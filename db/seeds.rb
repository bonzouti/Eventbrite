...
20.times do
    event = Event.create!(title: Faker::Pokemon.move, description: Faker::MostInterestingManInTheWorld.quote, user: User.all.sample, start_date: Faker::Date.forward(23), duration: rand(100..10000), price: rand(1..1000), location: Faker::HarryPotter.location)
   end
